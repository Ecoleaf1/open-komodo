...
public class SQLCode {
	public static enum SQLCodeType {CREATE_MAIN_TABLE, CREATE_MODERATION_TABLE, ADD_MODHISTORY_COLUMN, CREATE_BAG_INVENTORY, CREATE_BAG_INVENTORY_TABLE, CREATE_MAIL_TABLE, SET_BAG_INVENTORY, GET_BAG_INVENTORY, GET_LATEST_BAGID, CREATE_WORLD_TABLE,
		...
		GET_MAIL, COUNT_MAIL, SEND_MAIL, CLEAR_MAIL,GET_MUTEDATE, SET_MUTEDATE, GET_BANDATE, SET_BANDATE, SET_MODHISTORY, GET_MODHISTORY, ADD_MODHISTORY, GET_MUTEREASON, SET_MUTEREASON, GET_BANREASON, SET_BANREASON, SET_HOMES, GET_HOMES, GET_POINTS, GET_COINS, SET_POINTS, SET_COINS,
	...
	public static final @Nullable String getSQLCode(@NotNull SQLCodeType type) {
		...
		case CREATE_MODERATION_TABLE:
			...
			case ADD_MODHISTORY_COLUMN:
			return "ALTER TABLE `OpenKomodo.Moderation` ADD `Punishment History` BLOB NOT NULL AFTER `Ban Reason`;";
		case SET_MODHISTORY:
				return "UPDATE `OpenKomodo.Moderation` SET `Punishment History` = ? WHERE `UUID` = ?";
		case CREATE_PLAYER:
		...
		case CREATE_WORLD_TABLE:
			return "CREATE TABLE IF NOT EXISTS `OpenKomodo.Worlds.%s` ( "
					...
					+ "`Permissions` BLOB);";
		case GET_FULL_PLAYER:
			return "SELECT * FROM `OpenKomodo.Main` WHERE UUID = ?";
		case GET_ACTIVE_TAG:
		...
		case GET_BANDATE:
			...
			"WHERE `UUID` = ?;";
		case GET_MODHISTORY:
			return "SELECT `Punishment History` FROM  `OpenKomodo.Moderation`" +
					"WHERE `UUID` = ?";
		case GET_BANREASON:
